...
<div class="space-y-6">
  <PageHeader title="Create ConfigMap" description="Create a new Kubernetes ConfigMap">
    {#snippet actions()}
      ...
      {#if yamlMode}
        ...
        <Card>
          <CardHeader>
            ...
            <p class="mt-1 text-sm text-muted-foreground">Edit the ConfigMap YAML directly</p>
          </CardHeader>
          <CardContent>
            <YamlEditor value={yamlContent} resourceKind="ConfigMap" {namespace} />
          </CardContent>
        </Card>
      {:else}
        <!-- Form Editor -->
        <Card>
          <CardHeader>
            ...
            <p class="mt-1 text-sm text-muted-foreground">Configure your ConfigMap</p>
          </CardHeader>
                ...
                {#each dataEntries as entry, index}
                  <div class="flex gap-2">
                    ...
                    <Textarea
                      value={entry.value}
                      oninput={(e) =>
                        updateDataEntry(index, 'value', (e.target as HTMLTextAreaElement).value)}
                      placeholder="Value"

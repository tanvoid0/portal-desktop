          ...
          <Card>
            <CardHeader>
              <CardTitle class="flex items-center gap-2">
                <Icon icon="mdi:clipboard-text" class="h-5 w-5" />
                Task Details
              </CardTitle>
            </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    <Icon icon="mdi:subdirectory-arrow-right" class="h-5 w-5" />
                    Subtasks
                  </div>
                  <Button
                    variant="outline"
                  ...
                  <div class="space-y-2">
                    {#each subtasks as subtask}
                      ...
                      {:else}
                        <!-- Subtask Display -->
                        <div
                          class="rounded-lg border border-border p-3 transition-colors hover:bg-muted/50"
                        >
                          ...
                          {#if subtask.description}
                            <p class="ml-6 mt-2 text-sm text-muted-foreground">
                              {subtask.description}
                            </p>
                          {/if}
                        </div>
          ...
          <Card>
            ...
            <CardContent class="space-y-2">
              <Button
                ...
                class="w-full justify-start"
              >
                <Icon icon="mdi:progress-clock" class="mr-2 h-4 w-4" />
                Toggle Status
              </Button>

...
<div class="space-y-6">
  ...
  {:else if error}
    <PageError title="Failed to load SDK versions" message={error} onRetry={loadVersions} />
  {:else if versions.length === 0}
    <PageEmpty
      title="No SDK versions found"
      description="Install an SDK from the SDK overview to manage versions here."
      actionLabel="Refresh"

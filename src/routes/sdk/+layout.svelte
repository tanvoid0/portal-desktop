...
<ShellSidebarLayout sidebarClass="flex h-full min-h-0 flex-col" mobileTriggerLabel="SDK menu">
  {#snippet sidebar()}
    <SDKSidebar selectedSDK={currentPath.split('/').pop() || undefined} {navigationItemIds} />
  {/snippet}

...
<script lang="ts">
	...
	// Set breadcrumb
	setBreadcrumbs([{ label: 'Scripts', href: '/scripts' }]);
	...
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="text-muted-foreground mt-1">
				Create, manage, and run reusable scripts for your workflows
			</p>
		</div>
	...
	{:else if filteredScripts().length === 0}
		<Card>
			<CardContent class="py-12 text-center">
				...
				<p class="text-muted-foreground mb-4">No scripts found</p>

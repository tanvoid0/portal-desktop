    ...
    <div class="flex flex-col items-center gap-4 py-4">
      ...
      {:else if qrCodeDataUrl}
        <div class="flex flex-col items-center gap-4">
          <div
            class="flex items-center justify-center rounded-lg border-2 border-border bg-white p-4"
          >
            <img src={qrCodeDataUrl} alt="QR Code" class="block h-64 w-64" />
          </div>

          <div class="w-full space-y-3">
            <div class="flex items-center gap-2 rounded-md bg-muted p-3">
              <code class="flex-1 break-all text-sm">{url}</code>
              <Button
                variant="ghost"
                size="icon"
            ...
            {#if passcode}
              <div class="space-y-2">
                <div
                  class="flex items-center gap-2 rounded-md border border-primary/20 bg-primary/10 p-3"
                >

      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent class="space-y-3">
            ...
            <div class="flex flex-wrap gap-2">
              <Badge class="bg-status-success-bg text-status-success">Success</Badge>
              <Badge class="bg-status-warning-bg text-status-warning">Warning</Badge>
      ...
      <CardContent>
        <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
          {#each ['Buttons', 'Cards', 'Forms', 'Icons'] as label}
            <div class="flex items-center space-x-2 rounded-lg bg-status-success/10 p-3">

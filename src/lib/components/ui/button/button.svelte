<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-gradient-to-r from-primary via-primary/95 to-primary text-primary-foreground shadow-button hover:shadow-button-hover hover:from-primary/95 hover:via-primary hover:to-primary/95",
				destructive:
				...
				secondary: "bg-gradient-to-r from-secondary via-secondary/95 to-secondary text-secondary-foreground shadow-button hover:shadow-button-hover hover:from-secondary/90 hover:via-secondary hover:to-secondary/90",
				ghost: "hover:bg-accent/60 hover:text-accent-foreground dark:hover:bg-accent/40 rounded-lg",
...
{#if href}
	...
	>
		{#if variant === 'default' || variant === 'destructive' || variant === 'secondary'}
			<span class="absolute inset-0 bg-gradient-to-r from-white/15 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
		{/if}

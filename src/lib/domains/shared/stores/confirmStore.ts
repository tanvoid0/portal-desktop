...
const DESTRUCTIVE_TITLE_PATTERN = /\b(delete|remove|uninstall|discard|rollback|reset)\b/i;
...
export const confirmActions = {
  request(message: string, title = 'Confirm', options: ConfirmOptions = {}): Promise<boolean> {

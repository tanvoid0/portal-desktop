...
export class BlockLibraryService {
  ...
  private initializeDefaultBlocks(): void {
    this.defaultBlocks = [
      ...
      },
      {
        ...
        command:
          'pip install -r ${requirementsFile}${upgrade ? " --upgrade" : ""}',
        executionType: "command",
      ...
      },
      {
        ...
        command:
          'mvn package${skipTests ? " -DskipTests" : ""}${profile ? ` -P${profile}` : ""}',
        executionType: "command",
      ...
      },
      {
        ...
        command:
          './gradlew test${testFilter ? ` --tests "${testFilter}"` : ""}',
        executionType: "command",
      ...
      // Spring Boot Specific
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn spring-boot:run" : "./gradlew bootRun"}${profile ? ` -Dspring.profiles.active=${profile}` : ""}',
        executionType: "command",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn test" : "./gradlew test"} -Dspring.profiles.active=${testProfile}',
        executionType: "command",
      ...
      // Database Migration
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn flyway:migrate" : "./gradlew flywayMigrate"}',
        executionType: "command",
      ...
      },
      {
        ...
        description:
          "Run Liquibase database migrations (apply pending changesets)",
        category: "utility",
        version: "1.0.0",
        parameters: [
          {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:update" : "./gradlew liquibaseUpdate"}${contexts ? ` -Dliquibase.contexts=${contexts}` : ""}',
        executionType: "command",
      ...
      },
      {
        ...
        description:
          "Check Liquibase migration status (count of pending changesets)",
        category: "utility",
        version: "1.0.0",
        parameters: [
          {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:status" : "./gradlew liquibaseStatus"}',
        executionType: "command",
        defaultConfig: { buildTool: "maven" },
        tags: [
          "spring-boot",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:validate" : "./gradlew liquibaseValidate"}',
        executionType: "command",
        defaultConfig: { buildTool: "maven" },
        tags: [
          "spring-boot",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:updateTestingRollback" : "./gradlew liquibaseUpdateTestingRollback"}',
        executionType: "command",
        defaultConfig: { buildTool: "maven" },
        tags: [
          "spring-boot",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:rollback" : "./gradlew liquibaseRollback"}${rollbackCount ? ` -Dliquibase.rollbackCount=${rollbackCount}` : ""}${rollbackTag ? ` -Dliquibase.rollbackTag=${rollbackTag}` : ""}',
        executionType: "command",
        defaultConfig: {
          buildTool: "maven",
          rollbackCount: 1,
      ...
      },
      {
        ...
        description:
          "Clear Liquibase checksums (useful when changelog is modified)",
        category: "utility",
        version: "1.0.0",
        parameters: [
          {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:clearCheckSums" : "./gradlew liquibaseClearChecksums"}',
        executionType: "command",
        defaultConfig: { buildTool: "maven" },
        tags: [
          "spring-boot",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:generateChangeLog" : "./gradlew liquibaseGenerateChangelog"}${outputFile ? ` -Dliquibase.changeLogFile=${outputFile}` : ""}',
        executionType: "command",
      ...
      },
      {
        ...
        command:
          '${buildTool === "maven" ? "mvn liquibase:tag" : "./gradlew liquibaseTag"} -Dliquibase.tag=${tagName}',
        executionType: "command",
        defaultConfig: { buildTool: "maven" },
        tags: [
          "spring-boot",
      ...
      },
      {
        ...
        command:
          'curl -X PUT ${consulUrl}/v1/agent/service/register -d \'{"ID":"${serviceName}","Name":"${serviceName}"}\'',
        executionType: "command",
      ...
      // Manual Approval
      {
        ...
        description:
          "Pause pipeline and wait for manual approval before continuing",
        category: "utility",
        version: "1.0.0",
        parameters: [
          {
      ...
      // VPN Connection
      {
        ...
        command:
          'sudo openvpn --config "${configDir}/${configFile}" --auth-retry interact --auth-user-pass "${configDir}/${authFile}"',
  ...
  async updateBlock(
    blockId: string,
    request: Partial<CreateBlockRequest>,
  ): Promise<Block> {
    try {

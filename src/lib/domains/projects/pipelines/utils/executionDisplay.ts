...
import { CheckCircle2, Circle, Loader2, XCircle, Ban, SkipForward } from '@lucide/svelte';
import type { ExecutionStatus } from '../types';

export function getExecutionStatusIcon(status: ExecutionStatus | string): Component {
  switch (status) {
    case 'success':
      return CheckCircle2;
    case 'failed':

 ...
 */
export function samplingExtras(
  ...
  if (settings.repeatPenalty != null)
    extras.repeat_penalty = settings.repeatPenalty;
  if (settings.presencePenalty != null)
    extras.presence_penalty = settings.presencePenalty;

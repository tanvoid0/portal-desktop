    ...
    settingsProp
      ? {
          ...
          windowState: {
            ...
            ...(settingsProp.windowState || {}),
          },
          startupBehavior: {
            ...defaultSettings.startupBehavior,
            ...(settingsProp.startupBehavior || {}),
          },
          notifications: {
            ...defaultSettings.notifications,
            ...(settingsProp.notifications || {}),
            types: {
              ...defaultSettings.notifications.types,
              ...(settingsProp.notifications?.types || {}),
            },
          },
          privacy: {
            ...defaultSettings.privacy,
            ...(settingsProp.privacy || {}),
          },
          updates: {
      ...
      <div class="flex items-center justify-between">
        <div class="space-y-0.5">
          ...
          <p class="text-sm text-muted-foreground">
            Automatically open the last session on startup
          </p>
        </div>
        <Switch
          id="openLastSession"
        ...
        <Switch
          ...
          onclick={() =>
            onUpdate({
              privacy: {
                ...settings.privacy,
                crashReports: !(settings.privacy?.crashReports ?? false),
              },
            })}
        />
      </div>
        ...
        <Switch
          ...
          onclick={() =>
            onUpdate({
              updates: {
                ...settings.updates,
                notifyOnUpdate: !(settings.updates?.notifyOnUpdate ?? false),
              },
            })}
        />
      </div>

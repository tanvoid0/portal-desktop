...
<script lang="ts">
  ...
  function getAllFrameworks(): Array<{
    name: string;
    icon: string;
    category: string;
    isCustom: boolean;
    ...
    <CardContent>
      ...
      {:else if ides.length === 0}
        <div class="py-8 text-center">
          <Code2 class="mx-auto mb-4 h-12 w-12 text-muted-foreground" />
          <p class="mb-4 text-muted-foreground">No IDEs configured</p>
    ...
    <CardContent>
      ...
      {:else if ides.length === 0}
        <div class="py-8 text-center">
          ...
          <p class="mb-2 text-muted-foreground">No IDEs configured</p>
          <p class="mb-4 text-sm text-muted-foreground">
            Please add an IDE first before creating framework mappings
          </p>
        </div>
      {:else if mappings.length === 0}
        <div class="space-y-6">
          <div class="py-4 text-center">
            ...
            <p class="mb-4 text-sm text-muted-foreground">
              Quickly add common frameworks below or create a custom mapping
            </p>
          </div>
                        ...
                        <div class="group relative">
                          ...
                          >
                            ...
                            <Button
                              ...
                              onclick={() => deleteFramework(framework)}
                            >
                              <X class="h-3 w-3" />
                            </Button>
                          </div>
      ...
      {:else}
        <div class="space-y-4">
          ...
          {#if (() => {
            ...
            const unmappedFrameworks = allFrameworksList.filter((fw) => !mappings.some((m) => m.framework.toLowerCase() === fw.name.toLowerCase()));
      ...
      <div class="space-y-2">
          ...
          <div class="space-y-2">
            ...
            {#if frameworkIcon}
              <div class="flex items-center gap-3 rounded-md border p-3">
                <Icon icon={frameworkIcon} class="h-8 w-8" />
                <div class="flex-1">
        ...
        {:else}
          <div class="space-y-2">
            ...
            {#if frameworkIcon}
              <div class="flex items-center gap-3 rounded-md border p-3">
                <img src={frameworkIcon} alt="Framework icon" class="h-8 w-8" />
                <div class="flex-1">
                  <p class="truncate text-sm font-medium">{frameworkIcon}</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    class="mt-1 h-6"

...
<div class="space-y-6">
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>Current state and activity of the ML learning system</CardDescription>
    </CardHeader>
      ...
      {#if memoryStats}
        <div class="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <div class="text-xs text-muted-foreground">User preferences stored</div>
          </div>
        </div>
  ...
  <Card>
    <CardHeader>
      ...
      <CardDescription>View learned patterns, events, and preferences</CardDescription>
    </CardHeader>
    <CardContent>
      <Tabs bind:value={activeTab}>
        ...
        <TabsContent value="patterns" class="mt-4 space-y-4">
          {#if isLoadingDashboard}
            <div class="py-8 text-center text-muted-foreground">Loading patterns...</div>
          {:else if patterns.length === 0}
            <div class="py-8 text-center text-muted-foreground">
              <p>No patterns learned yet.</p>
              <p class="mt-2 text-xs">Patterns will appear here as you use the application.</p>
            </div>
          {:else}
            <div class="space-y-2">
              <div class="flex items-center gap-2">
        ...
        <TabsContent value="events" class="mt-4 space-y-4">
          {#if isLoadingDashboard}
            <div class="py-8 text-center text-muted-foreground">Loading events...</div>
                ...
                <Card class="p-3">
                  <div class="flex items-start justify-between gap-4">
                    <div class="flex-1 space-y-1">
                      ...
                      <div class="max-h-24 overflow-y-auto rounded bg-muted p-2 font-mono text-xs">
        ...
        <TabsContent value="preferences" class="mt-4 space-y-4">
          {#if isLoadingDashboard}
            <div class="py-8 text-center text-muted-foreground">Loading preferences...</div>
          {:else if preferences.length === 0}
            <div class="py-8 text-center text-muted-foreground">
              <p>No preferences learned yet.</p>
              <p class="mt-2 text-xs">
                Preferences will appear here as the system learns your preferences.
              </p>
            </div>
          {:else}
            <div class="max-h-[600px] space-y-2 overflow-y-auto">
      ...
      <div class="flex justify-end">
        <Button variant="ghost" size="sm" onclick={loadDashboardData} disabled={isLoadingDashboard}>
          <RefreshCw class="mr-2 h-4 w-4 {isLoadingDashboard ? 'animate-spin' : ''}" />
          Refresh Dashboard
        </Button>
      </div>
    </CardContent>

...
<script lang="ts">
  ...
  import { Plus, Play, Edit, Trash2, Terminal, FileCode } from '@lucide/svelte';
  import {
    CustomScriptService,
    type CustomScript,
  ...
  import ScriptRunner from '$lib/domains/custom_scripts/components/ScriptRunner/ScriptRunner.svelte';
  ...
  async function loadScripts() {
    ...
    try {
      ...
      toast.error('Failed to load scripts', error);
...
<div class="container mx-auto p-6 space-y-6">
  <PageHeader title="Utilities" description="Manage and run custom scripts">
    {#snippet actions()}
  ...
  {:else if filteredScripts.length === 0}
    <PageEmpty
      ...
      filteredDescription="No scripts match your search."
              ...
              <div class="space-y-2">
                ...
                <div class="space-y-2">
                  <div class="flex gap-2">
                    ...
                    {:else}
                      <Button size="sm" onclick={() => handleRunScript(script)} class="flex-1">

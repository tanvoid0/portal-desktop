...
export const AGENT_MODE_CYCLE: CoderAgentMode[] = ['plan', 'debug', 'multitask', 'ask', 'auto'];
...
export const AGENT_MODES: AgentModeConfig[] = [
  {
    ...
    itemClass:
      'focus:bg-violet-500/10 data-[state=checked]:text-violet-700 dark:data-[state=checked]:text-violet-300',
  },
  {
    value: 'debug',
    label: 'Debug',
    ...
    itemClass:
      'focus:bg-amber-500/10 data-[state=checked]:text-amber-700 dark:data-[state=checked]:text-amber-300',
  },
  {
    value: 'multitask',
    label: 'Multitask',
    ...
    itemClass:
      'focus:bg-purple-500/10 data-[state=checked]:text-purple-700 dark:data-[state=checked]:text-purple-300',
  },
  {
    value: 'ask',
    label: 'Ask',
    ...
    itemClass:
      'focus:bg-teal-500/10 data-[state=checked]:text-teal-700 dark:data-[state=checked]:text-teal-300',
  },
  {
    value: 'auto',
    label: 'Auto',
...
export function inferEffectiveMode(text: string, agentMode: CoderAgentMode): CoderAgentMode | null {

...
export class SDKService {
  ...
  /**
   * Check whether a given SDK manager (nvm, pyenv, …) is installed.
   */
  ...
  /**
   * Start a background SDK service (returns its pid).
   */
  async startService(
    sdkType: string,
    version: string,
  ...
  /**
   * Download + install a version (optionally through its manager).
   */

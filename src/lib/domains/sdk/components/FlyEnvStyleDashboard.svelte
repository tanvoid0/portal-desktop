  ...
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="text-muted-foreground">
        FlyEnv-style comprehensive development environment management
      </p>
    </div>
    <div class="flex gap-2">
      <Button variant="outline" onclick={handleRefresh} disabled={refreshing}>
        <span class="mr-2 h-4 w-4" class:animate-spin={refreshing}>
          <RefreshCw />
        </span>
        Refresh
      </Button>
        ...
        <DialogContent class="sm:max-w-md">
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-2">
              ...
              <Button
                variant="outline"
                onclick={handleProjectEnvironmentSetup}
                disabled={!selectedProjectPath}
              >
              ...
              <Button
                variant="outline"
                onclick={handleTerminalIntegration}
                disabled={!selectedProjectPath}
              >
          ...
          <CardContent class="space-y-4">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="flex items-start space-x-3">
                <Zap class="mt-1 h-5 w-5 text-blue-500" />
                <div>
              ...
              <div class="flex items-start space-x-3">
                <Globe class="mt-1 h-5 w-5 text-green-500" />
                <div>
              ...
              <div class="flex items-start space-x-3">
                <Container class="mt-1 h-5 w-5 text-purple-500" />
                <div>
              ...
              <div class="flex items-start space-x-3">
                <Settings class="mt-1 h-5 w-5 text-orange-500" />
                <div>
          ...
          <div class="space-y-2">
            ...
            <div class="rounded-md bg-muted p-3">
              <div class="font-medium">
                {selectedManager.display_name || selectedManager.name}
              </div>

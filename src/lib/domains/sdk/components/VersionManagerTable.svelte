      ...
      <div>
        ...
        {#if suggestedVersion}
          <p class="mt-1 flex items-center gap-1 text-sm text-muted-foreground">
            ...
            Suggested version:
            <code class="font-mono text-primary">{suggestedVersion}</code>
          </p>
        {/if}
      </div>
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b">
              ...
              <th class="p-3 text-left font-medium">Path</th>
              <th class="p-3 text-left font-medium">ENV Status</th>
              <th class="p-3 text-left font-medium">Aliases</th>

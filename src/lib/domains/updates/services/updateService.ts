...
import type { UpdateCheckResult, UpdateErrorInfo, UpdateInfo, UpdateInstallResult } from '../types';
...
export function parseUpdateError(error: unknown): UpdateErrorInfo {
  ...
  if (
    ...
    return {
      ...
      message: 'The available update could not be verified. For your safety, it was not installed.',
  ...
  if (
    ...
    return {
      ...
      message: 'The app could not read update information from the release server.',

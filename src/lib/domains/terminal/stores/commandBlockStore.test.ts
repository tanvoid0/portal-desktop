...
import { appendCapped, MAX_BLOCK_OUTPUT, TRUNCATION_NOTICE } from './commandBlockStore';
...
describe('appendCapped', () => {
  ...
  it('keeps output bounded once the cap is exceeded', () => {
    ...
    expect(output.length).toBeLessThanOrEqual(MAX_BLOCK_OUTPUT + TRUNCATION_NOTICE.length);
  });

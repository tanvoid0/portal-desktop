...
use crate::domains::sdk::services::language_config_service::{
    ProcessedSDKConfig, ProcessedSDKManager, SDKConfigService,
};

/// Get processed SDK configuration
#[tauri::command]
pub async fn get_sdk_config(sdk_id: String) -> Result<Option<ProcessedSDKConfig>, String> {
...
#[tauri::command]
pub async fn get_sdks_by_category(category: String) -> Result<Vec<ProcessedSDKConfig>, String> {

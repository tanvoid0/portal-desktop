...
impl SDKManager for RbenvManager {
    ...
    async fn switch_version(&self, _version: &str) -> Result<(), SDKError> {
        Ok(())
    }
    ...
    async fn is_version_installed(&self, _version: &str) -> Result<bool, SDKError> {
        Ok(false)
    }

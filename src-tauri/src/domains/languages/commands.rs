use crate::domains::languages::entities::{SuggestedLanguage, LanguageGroup};
...
pub async fn get_suggested_languages(
    ...
    let groups = vec![
        LanguageGroup {
            ...
            languages: vec![
                SuggestedLanguage { name: "JavaScript".to_string(), icon: "logos:javascript".to_string(), category: "Web".to_string() },
                SuggestedLanguage { name: "TypeScript".to_string(), icon: "logos:typescript-icon".to_string(), category: "Web".to_string() },
                SuggestedLanguage { name: "HTML".to_string(), icon: "logos:html-5".to_string(), category: "Web".to_string() },
                SuggestedLanguage { name: "CSS".to_string(), icon: "logos:css-3".to_string(), category: "Web".to_string() },
            ],
        },
        LanguageGroup {
            category: "Backend".to_string(),
            languages: vec![
                SuggestedLanguage { name: "Python".to_string(), icon: "logos:python".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "Rust".to_string(), icon: "logos:rust".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "Go".to_string(), icon: "logos:go".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "Java".to_string(), icon: "logos:java".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "C#".to_string(), icon: "logos:c-sharp".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "PHP".to_string(), icon: "logos:php".to_string(), category: "Backend".to_string() },
                SuggestedLanguage { name: "Ruby".to_string(), icon: "logos:ruby".to_string(), category: "Backend".to_string() },
            ],
        },
        LanguageGroup {
            category: "Mobile".to_string(),
            languages: vec![
                SuggestedLanguage { name: "Swift".to_string(), icon: "logos:swift".to_string(), category: "Mobile".to_string() },
                SuggestedLanguage { name: "Kotlin".to_string(), icon: "logos:kotlin-icon".to_string(), category: "Mobile".to_string() },
                SuggestedLanguage { name: "Dart".to_string(), icon: "logos:dart".to_string(), category: "Mobile".to_string() },
            ],
        },
        LanguageGroup {
            category: "Systems".to_string(),
            languages: vec![
                SuggestedLanguage { name: "C".to_string(), icon: "logos:c".to_string(), category: "Systems".to_string() },
                SuggestedLanguage { name: "C++".to_string(), icon: "logos:c-plusplus".to_string(), category: "Systems".to_string() },
                SuggestedLanguage { name: "Rust".to_string(), icon: "logos:rust".to_string(), category: "Systems".to_string() },
            ],
        },
        LanguageGroup {
            category: "Functional".to_string(),
            languages: vec![
                SuggestedLanguage { name: "Haskell".to_string(), icon: "logos:haskell-icon".to_string(), category: "Functional".to_string() },
                SuggestedLanguage { name: "Elixir".to_string(), icon: "logos:elixir".to_string(), category: "Functional".to_string() },
                SuggestedLanguage { name: "F#".to_string(), icon: "logos:f-sharp".to_string(), category: "Functional".to_string() },
            ],
        },
    ];
    ...
    if !learned_languages.is_empty() {
        ...
        if !recommended_languages.is_empty() {
            ...
            groups_with_recommended.insert(0, LanguageGroup {

...
use crate::domains::ide::entities::{
    FrameworkGroup, FrameworkIdeMapping, IdeConfig, SuggestedFramework,
};
...
#[tauri::command]
pub async fn get_all_ides(db: State<'_, Arc<DatabaseManager>>) -> Result<Vec<IdeConfig>, String> {
...
#[tauri::command]
pub async fn delete_ide(id: i64, db: State<'_, Arc<DatabaseManager>>) -> Result<i64, String> {
    let conn = db.get_connection_clone();
...
#[tauri::command]
pub async fn set_default_ide(id: i64, db: State<'_, Arc<DatabaseManager>>) -> Result<i64, String> {
    let conn = db.get_connection_clone();
...
pub async fn get_all_framework_ide_mappings(
    ...
    Ok(mappings
        .into_iter()
        .map(|mapping| FrameworkIdeMapping {
    ...
    for pattern in &learned_patterns {
        if let Ok(data) = serde_json::from_str::<serde_json::Value>(&pattern.pattern_data) {
            if let Some(framework) = data.get("framework").and_then(|v| v.as_str()) {
                ...
                if let Some((_, freq)) = learned_frameworks
                    .iter_mut()
        ...
        FrameworkGroup {
            ...
            frameworks: vec![
                SuggestedFramework {
                    ...
                    icon: "logos:react".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Vue".to_string(),
                    icon: "logos:vue".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Angular".to_string(),
                    icon: "logos:angular-icon".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Svelte".to_string(),
                    icon: "logos:svelte-icon".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Next.js".to_string(),
                    icon: "logos:nextjs-icon".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Nuxt".to_string(),
                    icon: "logos:nuxt-icon".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Remix".to_string(),
                    icon: "logos:remix-icon".to_string(),
                    category: "Frontend".to_string(),
                },
                SuggestedFramework {
                    name: "Gatsby".to_string(),
                    icon: "logos:gatsby".to_string(),
                    category: "Frontend".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                SuggestedFramework {
                    ...
                    icon: "logos:nodejs-icon".to_string(),
                    category: "Backend".to_string(),
                },
                SuggestedFramework {
                    name: "Express".to_string(),
                    icon: "logos:express".to_string(),
                    category: "Backend".to_string(),
                },
                SuggestedFramework {
                    name: "Fastify".to_string(),
                    icon: "logos:fastify-icon".to_string(),
                    category: "Backend".to_string(),
                },
                SuggestedFramework {
                    name: "NestJS".to_string(),
                    icon: "logos:nestjs".to_string(),
                    category: "Backend".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                SuggestedFramework {
                    ...
                    icon: "logos:django-icon".to_string(),
                    category: "Python".to_string(),
                },
                SuggestedFramework {
                    name: "Flask".to_string(),
                    icon: "logos:flask".to_string(),
                    category: "Python".to_string(),
                },
                SuggestedFramework {
                    name: "FastAPI".to_string(),
                    icon: "logos:fastapi-icon".to_string(),
                    category: "Python".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                ...
                SuggestedFramework {
                    ...
                    icon: "logos:rails".to_string(),
                    category: "Ruby".to_string(),
                },
                SuggestedFramework {
                    name: "Sinatra".to_string(),
                    icon: "logos:sinatra".to_string(),
                    category: "Ruby".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                ...
                SuggestedFramework {
                    ...
                    icon: "logos:laravel".to_string(),
                    category: "PHP".to_string(),
                },
                SuggestedFramework {
                    name: "Symfony".to_string(),
                    icon: "logos:symfony".to_string(),
                    category: "PHP".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                ...
                SuggestedFramework {
                    ...
                    icon: "logos:spring-icon".to_string(),
                    category: "Java".to_string(),
                },
                SuggestedFramework {
                    name: "Quarkus".to_string(),
                    icon: "logos:quarkus-icon".to_string(),
                    category: "Java".to_string(),
                },
            ],
        },
        FrameworkGroup {
            ...
            frameworks: vec![
                SuggestedFramework {
                    ...
                    icon: "logos:tauri".to_string(),
                    category: "Desktop".to_string(),
                },
                SuggestedFramework {
                    name: "Electron".to_string(),
                    icon: "logos:electron".to_string(),
                    category: "Desktop".to_string(),
                },
                SuggestedFramework {
                    name: "Flutter".to_string(),
                    icon: "logos:flutter".to_string(),
                    category: "Desktop".to_string(),
                },
            ],
        },
...
#[tauri::command]
pub async fn delete_framework(id: i32, db: State<'_, Arc<DatabaseManager>>) -> Result<(), String> {
    let conn = db.get_connection_clone();

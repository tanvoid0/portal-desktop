  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "card-flat":
          "0 1px 3px 0 rgba(0, 0, 0, 0.08), 0 1px 2px 0 rgba(0, 0, 0, 0.12)",
        "card-raised":
          "0 6px 12px -2px rgba(0, 0, 0, 0.12), 0 4px 8px -3px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(0, 0, 0, 0.08)",
        "card-elevated":
          "0 12px 24px -4px rgba(0, 0, 0, 0.15), 0 8px 16px -6px rgba(0, 0, 0, 0.18), 0 0 0 1px rgba(0, 0, 0, 0.08), 0 24px 48px -8px rgba(0, 0, 0, 0.12)",
        "card-hover":
          "0 20px 40px -6px rgba(0, 0, 0, 0.18), 0 12px 24px -8px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(0, 0, 0, 0.1), 0 32px 64px -12px rgba(0, 0, 0, 0.2)",
        button: "0 3px 6px rgba(0, 0, 0, 0.12), 0 2px 4px rgba(0, 0, 0, 0.08)",
        "button-hover":
          "0 6px 12px rgba(0, 0, 0, 0.15), 0 4px 8px rgba(0, 0, 0, 0.1)",
